...
class BESMCharacterApp(ui.QMainWindow):
    def __init__(self):
        ...
        with open(os.path.join(base_path, "data", "attributes.json"), "r", encoding="utf-8") as f:
            ...
            # Create a dictionary to look up attributes by key
        ...
        with open(os.path.join(base_path, "data", "defects.json"), "r", encoding="utf-8") as f:
            ...
            # Create a dictionary to look up defects by key
            self.defects_by_key = {}
            for defect in raw_defects:
                if "key" in defect and defect["key"]:
                    self.defects_by_key[defect["key"]] = defect
    ...
    def add_alternate_forms(self):
        # Simple placeholder for alternate forms
        form = {
            "id": str(uuid.uuid4()),
    ...
    def sync_special_attributes(self):
        """Sync all special attribute tabs"""
        # Sync alternate forms
        from tabs.alternate_forms_tab import sync_alternate_forms_from_attributes
        sync_alternate_forms_from_attributes(self)
